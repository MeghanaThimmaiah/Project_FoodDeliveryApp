...
def register_user(user_json, name, password, age, phn,address,email):
    user = {
        "id" : 1,
        "name" : name,
        "password": password,
...
def update_profile(user_json, name, password, age, phn,address,email):
    user = {
        "id" : 1,
        "name" : name,
        "password": password,
    ...
    for i in range(len(content1)):
        if content1[i]["name"] == food_name:
            if content1[i]["no of plates"] >= quantity:
                print("Your order has been accepted. Enjoy the Food")
...
def add_food(food_json, food_name, no_plates=1, price=1, discount=1):
    food = {
        "id":1,
        "name": food_name,
        "no of plates": no_plates,
        "price_for_one_plate": price,
        "discount": discount
    }
    try:
        fp = open(food_json, "r+")
...
#--------------Register----------------#
        ...
        register_user(user_json, name, password, age, phn,address,email)
                            ...
                            while True:
                                ...
                                if val3 == "1":
                                    ...
                                    while True:
                                        ...
                                        val4 = input("Enter your Choice User!! ")
                                        if val4 == "1":
                                        ...
                                        elif val4==input("Enter email: "):
                                            email=input("Enter new email: ")
                                        else:
                                            print("profile not updated with new update")
                                            break

                                    update_profile(user_json, name, password, age, phn, address, email)
